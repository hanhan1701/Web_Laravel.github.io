...
<body>
    <div class="login-wrap">
        <div class="login-html">
            ...
            <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"><a href="{{ route('dang-ky-kh')}}">Đăng ký</a></label>
            <div class="login-form">
                ...
                {{-- <div class="sign-up-htm">
                    ...
                    <div class="group">
                        ...
                        <input id="user" type="text" name="sdt" class="input">
                    </div>
                    <div class="group">
                        <label for="user" class="label">Tài khoản</label>
